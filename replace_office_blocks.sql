-- Delete the old ugly richText blocks
DELETE FROM Block WHERE id IN ('cmfbl0fc0004aan2uguek7mn4', 'cmfbl0fc0004ban2u3c2bx2lo');

-- Insert clean featureGrid blocks for offices
INSERT INTO Block (id, type, data, "order", pageId, createdAt, updatedAt)
VALUES (
    'global_offices_clean',
    'featureGrid',
...
-- Insert clean featureGrid blocks for global coverage
INSERT INTO Block (id, type, data, "order", pageId, createdAt, updatedAt)
VALUES (
