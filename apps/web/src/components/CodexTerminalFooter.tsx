...
export function CodexTerminalFooter() {
  return (
        ...
        <div className="grid lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center group mb-6">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-r from-primary-500 to-primary-600 shadow-sm group-hover:shadow-md transition-shadow">
            ...
            <div className="flex space-x-4">
              {navigation.social.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-gray-400 hover:text-primary-500 transition-colors p-2 rounded-lg hover:bg-gray-50"
                >
